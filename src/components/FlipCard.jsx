...
export function FlipCard() {
  return (
    <div className="flip-card" style={{ backgroundColor: 'transparent', width: '240px', height: '154px', perspective: '1000px', color: 'white' }}>
      <style>
        {`
      ...
      <div className="flip-card-inner" style={{ position: 'relative', width: '100%', height: '100%', textAlign: 'center', transition: 'transform 0.8s', transformStyle: 'preserve-3d' }}>
        <div className="flip-card-front" style={{ boxShadow: '0 8px 14px 0 rgba(0,0,0,0.2)', position: 'absolute', display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '100%', height: '100%', WebkitBackfaceVisibility: 'hidden', backfaceVisibility: 'hidden', borderRadius: '1rem', backgroundColor: '#171717' }}>
        ...
        <div className="flip-card-back" style={{ boxShadow: '0 8px 14px 0 rgba(0,0,0,0.2)', position: 'absolute', display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '100%', height: '100%', WebkitBackfaceVisibility: 'hidden', backfaceVisibility: 'hidden', borderRadius: '1rem', backgroundColor: '#171717', transform: 'rotateY(180deg)' }}>
