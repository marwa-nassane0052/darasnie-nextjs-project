...
export function FlipCard() {
  ...
  useEffect(() => {
    ...
    }, 1000); // Set the refreshing state back to false after 2 seconds

    return () => clearTimeout(timer); // Clean up the timer
  }, []);

  return (
    <div className={`flip-card ${isRefreshing ? 'refreshing' : ''}`} style={{ backgroundColor: 'transparent', width: '240px', height: '154px', perspective: '1000px', color: 'white' }}>
      <style>
        {`
          .flip-card {
          ...
          .flip-card.refreshing .flip-card-inner {
